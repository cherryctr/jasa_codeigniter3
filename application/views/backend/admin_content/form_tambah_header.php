        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
             <form action="<?php echo base_url(); ?>Proses/TambahHeader" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="number" name="angka" class="form-control"  placeholder="Input angka">
                  </div>
                  <!-- /.input group -->
                </div>
